<footer class="site-footer"><div class="container footer-main"><div><a href="./" class="brand-link" aria-label="FleetIQ home"><?php brand(); ?></a><p>Smarter Fleet Management</p></div><nav aria-label="Footer navigation"><a href="#product">Product</a><a href="#features">Features</a><a href="#about">About</a><a href="#contact">Contact</a></nav><span class="footer-location">Built around UK fleet operations.</span></div><div class="container footer-bottom"><span>© <?= date('Y') ?> FleetIQ. All rights reserved.</span><div><a href="#privacy" data-dialog="privacy">Privacy</a><a href="#terms" data-dialog="terms">Terms</a></div></div></footer>
